    ...
    <div class="container grid">
      ...
      <div class="socials socials-left">
        ...
        <ul class="footer__list">
          <li class="footer__item">
            <a
              href="https://github.com/purplehippo911"
              target="_blank"
              class="footer__link"
            >
              Purplehippo911
          ...
          <li class="footer__item">
            <a
              href="https://twitter.com/muggie43"
              target="_blank"
              class="footer__link"
            >
              muggie43
      ...
      <div class="socials socials-right">
        ...
        <ul class="footer__list">
          <li class="footer__item">
            <a
              href="https://github.com/SolarisX1337"
              target="_blank"
              class="footer__link"
            >
              SolarisX1337
...
.footer {
  @include mainArticle(100%, 1rem 0, $Black);
